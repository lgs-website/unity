...
namespace PigeonCoopToolkit.Effects.Trails
{
    public abstract class TrailRenderer_Base : MonoBehaviour
    {
        ...
        protected float _deltaTime { get { return ignoreTimeScale ? Time.unscaledDeltaTime : Time.deltaTime; } }
        ...
        protected virtual void Update()
        {
            ...
            {
                UpdatePoints(_activeTrail, _deltaTime);
                UpdateTrail(_activeTrail, _deltaTime);
            ...
            for (int i = _fadingTrails.Count-1; i >= 0; i--)
            {
                ...
                UpdatePoints(_fadingTrails[i], _deltaTime);
                UpdateTrail(_fadingTrails[i], _deltaTime);
